...
<html lang="en">
    <head>
        ...
        <style>
            .select2-container {                
                z-index: 9999; /* Establece un z-index alto para asegurarte de que esté por encima del modal */
                position: relative; /* Asegúrate de que el buscador tenga una posición relativa */
            }
        </style>
    </head>
    <body class="bg-dark">
